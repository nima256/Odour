...
mongoose
  ...
  .then(async () => {
    ...
    const category1 = await Category.findOne({ slug: "آرایش-صورت" });
    ...
    if (!category1) {
      console.error("Category1 not found");
      return;
    }
    if (!category2) {
      console.error("Category2 not found");
      return;
    }
    if (!category3) {
      console.error("Category3 not found");
      return;
    }
    if (!category4) {
      console.error("Category4 not found");
      return;
    }
